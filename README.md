# 🧙‍♂️ Spellcaster: A Magical Survival Challenge
...
- **Move:** Use `WASD` to navigate the battlefield.  
- **Attack:** Your spells **auto-cast** while you move.  
...
1. **Firebolt** (Default Spell) – Shoots fireballs towards your **mouse pointer**. Higher levels cast **more projectiles** at once.  
2. **Ice Spear** – Summons spears that circle around you before launching outward. **Upgrades increase spear count**.  
3. **Magic Orbs** – Orbs float around you, damaging nearby enemies. **Higher levels increase the number of orbs**.  
4. **Wind Gale** – Creates unpredictable wind blasts **randomly around you**. **Upgrading reduces cooldown time**.  
